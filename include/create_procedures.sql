...
AS 'BEGIN
  ...
  INSERT INTO PASSENGERS_PREFERENCES (DEPARTUREDATE, FLIGHTSTATUS, PASSENGERCODE, AGE, GENDER, TICKETTYPE, ARRIVALAIRPORT, AIRPORTNAME)
  SELECT DEPARTUREDATE, FLIGHTSTATUS, PASSENGERS.PASSENGERCODE, PASSENGERS.AGE,PASSENGERS.GENDER, PASSENGERS.TICKETTYPE, AIRPORTS.ARRIVALAIRPORT, AIRPORTS.AIRPORTNAME FROM PLANES
